  ...
  <div class="content-wrapper"  >
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
		    <h4 class="page-title">Gallery Section</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Gallery</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Update Gallery</a></li>
								 ...
								 <?php 
											...
											$name=mysqli_real_escape_string($dbcon,$_POST['name']);	
										   {
											...
											if (empty($_FILES['img']['name']))
												 {
											$query="update tbimg set name='$name' where id='$id'";
											if(mysqli_query($dbcon,$query))
											{
											echo "<script> alert('Updated Successfully');</script>";
                                            echo '<script>window.location.href = "show-gallery.php";</script>';
											}
											else{
											echo mysqli_error($dbcon);
												...
												$query="update tbimg set name='$name',pic1='$img' where id='$id'";																					
											if(mysqli_query($dbcon,$query))
											{
											echo "<script> alert('Updated Successfully');</script>";
