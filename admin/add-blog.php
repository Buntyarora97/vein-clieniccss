  ...
  <div class="content-wrapper"  >
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
            <h4 class="page-title">Events Section</h4>
            <ol class="breadcrumb">
     ...
     <div class="row" style="margin-bottom:150px;">
            ...
            <div class="card-body">
              <form action="#" method="POST" enctype="multipart/form-data">
               ...
               <!--- <div class="form-group row">
                  ...
                  <div class="form-group row">
                  <label for="name" class="col-sm-3 col-form-label">Heading</label>
                  <div class="col-sm-9">
                  ...
                  <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                    <label for="img" class="col-sm-3 col-form-label" style="margin-top:15px">Image</label>
                  <div class="col-sm-9">
                  <span>
                 ...
                 <!---<div class="col-md-4">
                  <div class="form-group row">
                    <div class="col-sm-4">
                    <img  src="" id="prev" name="prev" height="100px" width="100px">
                    </div>
                  </div>
                  </div>--->
                  
                <div class="form-footer">
                    <button  style="float:right" type="submit" name="btn4" id="btn4" class="btn btn-success"><i class="fa fa-check-square-o"></i> SAVE</button>
                </div>
                                          <?php 
        ...
        $query="insert into tbblog(photo,heading,description,status) VALUES ('$photo','$heading','$description','Active');";
