    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
		    ...
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Enquiry</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Update Enquiry</a></li>
            ...
            <div class="card-body">
              <form action="#" method="POST" enctype="multipart/form-data">
				...
				<?php 
													 ...
													 $id=$_GET['id'];
													 $counter = 0;
													 $sql="select * from tbenq where id='$id'";
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                   ...
                   <label for="enqsub" class="col-sm-2 col-form-label">Subject</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="enqsub" value="<?php echo $row['enqsub']; ?>" name="enqsub">
                  </div>
                </div>
                 <div class="form-group row">
				...
				<!---<div class="form-group row">
                  ...
                  <label for="enqsub" class="col-sm-2 col-form-label">Subject</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="4" id="enqsub"  name="enqsub"><?php echo $row['enqsub']; ?></textarea>
                  </div>
                </div>--->
                ...
                <div class="form-footer">
                    <button  style="float:right" type="submit" name="btn3" id="btn3" class="btn btn-primary"><i class="fa fa-edit"></i> Submit</button>
							 ...
							 <?php 
											...
											$query="Update tbenq set enqnam='$enqnam',enqmob='$enqmob',enqeml='$enqeml',enqsub='$enqsub',enqmsg='$enqmsg' where id='$id'";
