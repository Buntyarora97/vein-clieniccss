    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    ...
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Show Blog</a></li>
                ...
                <tbody>
                    <tr>
                       <td><?php echo ++$counter; ?></td>														
						  ...
						  <a href="update-blog.php?id=<?php echo $row['id'];?>" class="btn btn-warning " title="Update" style="padding:10px;"><i class="fa fa-times fa fa-edit"></i></a>
														
							<a href="delete-blog.php?id=<?php echo $row['id'];?>" class="btn btn-danger " title="Delete" style="padding:10px;"><i class="fa fa-times fa fa-white"></i></a>
