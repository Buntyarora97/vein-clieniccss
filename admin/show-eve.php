    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    ...
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Show Events</a></li>
          ...
          <div class="card">
            ...
            <th>Heading</th>
				...
				<? <?php 
									 ...
									 $counter = 0;
									 $sql="select * from tbevent order by id desc";
                ...
                <tbody>
                    <tr>
                       <td><?php echo ++$counter; ?></td>														
														...
														<td><?php echo date('d F, Y', strtotime($row['on_date'])); ?></td>--->
														
														<td><img src="assets/images/upload/event/<?php echo $row['photo'];?>" alt="" height="80px"></td>
							<td class="center">
													
						  <a href="update-eve.php?id=<?php echo $row['id'];?>" class="btn btn-warning " title="Update" style="padding:10px;"><i class="fa fa-times fa fa-edit"></i></a>
														
							<a href="delete-eve.php?id=<?php echo $row['id'];?>" class="btn btn-danger " title="Delete" style="padding:10px;"><i class="fa fa-times fa fa-white"></i></a>
