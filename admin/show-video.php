    ...
    <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
            ...
            <li class="breadcrumb-item"><a href="#">Show Video</a></li>
         </ol>
	   </div>
	 </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>Show Video</div>
            <div class="card-body">
                ...
                <tbody>
                    <tr>
                       <td><?php echo ++$counter; ?></td>
						...
						<td><img src="assets/images/upload/product/video/<?php echo $row['pic1']; ?>" style="width:100px;"></td>
							<td class="center">
													
						  <a href="update-video.php?id=<?php echo $row['id'];?>" class="btn btn-warning " title="Update" style="padding:10px;"><i class="fa fa-times fa fa-edit"></i></a>
														
							<a href="delete-video.php?id=<?php echo $row['id'];?>" class="btn btn-danger " title="Delete" style="padding:10px;"><i class="fa fa-times fa fa-white"></i></a>
