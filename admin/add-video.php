    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
            ...
            <li class="breadcrumb-item"><a href="javaScript:void();"> Add Video</a></li>
              ...
              <form action="#" method="POST" enctype="multipart/form-data">
                <h4 class="form-header text-uppercase">
				 ...
				 <!---------------------------->
				  ...
				  <label for="img" class="col-sm-2 col-form-label" style="margin-top:15px">Image</label>
                  <div class="col-sm-4">
				  <span>
                     <input style="margin-top:15px" type="file" class="form-control" id="img" name="img" required>
				  </span>
					</div>
                </div>
				 <!---------------------------->
                ...
                <div class="form-footer">
                    <button  style="float:right" type="submit" name="btn2" id="btn2" class="btn btn-success"><i class="fa fa-check-square-o"></i> SAVE</button>
			                               ...
			                               <?php 
											...
											$query="insert into tbvideo(title,link,pic1,status,date) VALUES ('$title','$link','$img','Active',CURDATE());";
