            ...
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
				...
				<?php 
									 ...
									 $counter = 0;
									 $sql="select * from tbimg order by id desc";
                    ...
                    <tr>
                       <td><?php echo ++$counter; ?></td>
						...
						<td><img src="assets/images/upload/product/gallery/<?php echo $row['pic1']; ?>" style="width:100px;"></td>
						  ...
						  <a href="update-gallery.php?id=<?php echo $row['id'];?>" class="btn btn-warning " title="Update" style="padding:10px;"><i class="fa fa-times fa fa-edit"></i></a>
														
							<a href="delete-gallery.php?id=<?php echo $row['id'];?>" class="btn btn-danger " title="Delete" style="padding:10px;"><i class="fa fa-times fa fa-white"></i></a>
