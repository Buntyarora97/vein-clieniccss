  ...
  <div class="content-wrapper"  >
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
		    <h4 class="page-title">Wall of Fame Section</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Fame</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Update Fame</a></li>
            ...
            <div class="card-body">
              <form action="#" method="POST" enctype="multipart/form-data">
				...
				<?php 
													 ...
													 $id=$_GET['id'];
													 $counter = 0;
													 $sql="select * from tbfame where id='$id'";
				  ...
				  <span>
					...
					<img style="margin-top:15px" src="assets/images/upload/product/gallery/<?php echo $row['pic1']; ?>" id="prev" name="prev" height="100px" width="100px">
				 </div>
				 </div>
								 ...
								 <?php 
											...
											$name=mysqli_real_escape_string($dbcon,$_POST['name']);	
										   {
											...
											if (empty($_FILES['img']['name']))
												 {
											$query="update tbfame set name='$name' where id='$id'";
											if(mysqli_query($dbcon,$query))
											{
											echo "<script> alert('Updated Successfully');</script>";
                                            echo '<script>window.location.href = "show-fame.php";</script>';
											}
											else{
											echo mysqli_error($dbcon);
												...
												$query="update tbfame set name='$name',pic1='$img' where id='$id'";																					
											if(mysqli_query($dbcon,$query))
											{
											echo "<script> alert('Updated Successfully');</script>";
											move_uploaded_file($tmpimg,'assets/images/upload/product/gallery/'.$img);
                                           echo '<script>window.location.href = "show-fame.php";</script>';
											}
											else{
											echo mysqli_error($dbcon);
