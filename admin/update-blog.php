          ...
          <div class="card">
			...
			<?php 
                  ...
                  <div class="col-sm-4">
                   ...
                   <label style="margin-top:15px;" for="name" class="col-sm-2 col-form-label">Description</label>
				 ...
				 <label style="margin-top:15px;" for="name" class="col-sm-2 col-form-label">Blog Date</label>
                  <div  style="margin-top:15px;" class="col-sm-4">
                ...
                <div class="form-footer">
                    <button  style="float:right" type="submit" name="btn14" id="btn3" class="btn btn-primary"><i class="fa fa-edit"></i> Submit</button>
								...
								<?php 
											...
											$query="update tbblog set heading='$heading',description='$description',date='$date' where id='$id'";
											if(mysqli_query($dbcon,$query))
											{
											echo "<script> alert('Details Updated Successfully');</script>";
                                            echo '<script>window.location.href = "show-blog.php";</script>';
											}
											...
											$query="update tbblog set heading='$heading',description='$description',photo='$photo' where id='$id'";
											if(mysqli_query($dbcon,$query))
											{
