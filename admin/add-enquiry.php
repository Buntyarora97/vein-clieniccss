    ...
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
		    ...
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();"> Add Enquiry</a></li>
            ...
            <div class="card-body">
              <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="enqsub" name="enqsub">
                  </div>
                </div>
				<div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="4" id="enqsub" name="enqmsg"></textarea>
                  </div>
                </div>
				...
				<?php
					include('connection.php');
						...
						$enqsub=mysqli_real_escape_string($dbcon,$_POST['enqsub']);
											...
											$query="insert into tbenq(enqnam,enqmob,enqeml,enqsub,enqmsg,added,date) VALUES ('$enqnam','$enqmob','$enqeml','$enqsub','$enqmsg','By Admin',CURDATE());";
